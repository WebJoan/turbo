...
- Auth - Django backend (dj-rest-auth + simplejwt via cookies)
...
| :------------------------------------------------------------------------------------ | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Signup / Signin      | Authentication via backend using **dj-rest-auth** with **JWT cookies**. |
...
| Profile         | Simple profile page backed by backend `/api/users/me/`                                                                                                                                                             |
