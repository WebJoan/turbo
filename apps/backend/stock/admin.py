...
class CompetitorBrandAdmin(ModelAdmin):
...
class CompetitorCategoryAdmin(ModelAdmin):
...
class CompetitorProductAdmin(ModelAdmin):
...
class CompetitorProductMatchAdmin(ModelAdmin):
...
class CompetitorPriceStockSnapshotAdmin(ModelAdmin):
    list_display = (
        "competitor",
        "competitor_product",
        "collected_at",
...
class OurPriceHistoryAdmin(ModelAdmin):
